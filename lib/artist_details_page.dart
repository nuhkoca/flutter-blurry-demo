import 'package:flutter_blurry_demo/models.dart';
import 'package:flutter/material.dart';
import 'package:flutter_blurry_demo/video_card.dart';
...
class ArtistDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: new Stack(
          fit: StackFit.expand, //wrap the entire screen
          children: <Widget>[ // have a background
